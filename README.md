...
| okta.oauth2.acrValues    | N/A             |          | The Authentication Context Reference supported by Okta in /authorize API. See [here](https://developer.okta.com/docs/reference/api/oidc/#request-parameters) for usage details.                                                                        |
| okta.oauth2.prompt                | false   |          | Support enrollment of a factor during an /authorize call by adding this parameter value. See [here](https://developer.okta.com/docs/reference/api/oidc/#request-parameters) for usage details.                                                         |
